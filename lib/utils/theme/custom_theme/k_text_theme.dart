...
class KTextTheme{
  ...
  static TextTheme lightTheme=TextTheme(
   ...
   headlineSmall: const TextStyle().copyWith(fontSize: 18.0,fontWeight: FontWeight.w600,color: Colors.black),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 110,fontWeight: FontWeight.normal,color: Colors.black),
...
static TextTheme darkTheme=TextTheme(
 ...
 labelMedium: const TextStyle().copyWith(fontSize: 110,fontWeight: FontWeight.normal,color: Colors.white),
